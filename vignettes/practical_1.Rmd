...
1. Understand that model structure may be subjective, there can be many approaches to answering a given question.

# Outline for Session

1. Get into groups of 4-6 (2 minutes)
1. Read through the excercise and choose a study question (5 minutes)
...
1. Discuss possible model structures for each study question (20 minutes)
