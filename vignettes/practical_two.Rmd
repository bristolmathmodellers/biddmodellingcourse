...
output: 
      ...
      word_document:
vignette: >
  %\VignetteIndexEntry{Practical 2: Compartmental Models to Equations}
...
```{r shlir-plot, eval = FALSE, fig.cap = pretty_figref(label = "SHLIR", caption = "Plot of the population in each SHLIR model compartment over time")}
## For an interactive graph change interactive to TRUE
