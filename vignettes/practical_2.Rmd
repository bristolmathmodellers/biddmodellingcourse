...
1. Test your changes by setting `gamma_L` to be a very large number and all other parameters to be the same as for the SEIR model. If everything is working correctly both models should give the same output.
...
Specify new model parameters here (with the units being years^-1^). The names of the new parameters will need to match those used in the model equations.
